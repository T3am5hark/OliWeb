...
>>>>>>> ae902e2a858401b8803cec3110982b21253c2c52
...
echo '<a href="steerAndSnap.cgi?position=5&pulses=1" class="btn btn-primary">&lt;</a>'
echo '<a href="steerAndSnap.cgi?position=15&pulses=30" class="btn btn-primary">Center</a>'
echo '<a href="steerAndSnap.cgi?position=25&pulses=1" class="btn btn-primary">&gt;</a>'
...
echo '<div class="btn-group btn-group-lg" role="group" aria-label="...">'
echo '<a href="snapshot.cgi" class="btn btn-success">Retake</a>'
echo '<a href="archiveSnapshot.cgi" class="btn btn-warning">Archive</a>'
echo '</div><br>'
